// Datos completos de proyectos del portafolio

export const projects = [
  {
    id: 'cyberguard-ai',
    slug: 'cyberguard-ai',
    title: 'CyberGuard AI Enterprise',
    category: 'Ciberseguridad',
    status: 'En Construcción',
    featured: true,
    shortDescription: 'Plataforma de ciberseguridad de última generación con IA para detección proactiva de amenazas en tiempo real.',
    description: `CyberGuard AI Enterprise es una solución innovadora de ciberseguridad que combina inteligencia artificial, machine learning y análisis de comportamiento para ofrecer protección proactiva contra amenazas avanzadas.

La plataforma revoluciona la seguridad tradicional al utilizar modelos de IA entrenados para detectar patrones de ataque sofisticados, anomalías en el comportamiento del sistema y vulnerabilidades zero-day antes de que sean explotadas.`,

    fullDescription: `## Visión General
...
- **ROI**: Reducción de 60% en costos de seguridad`,

    technologies: [
      'Python', 'FastAPI', 'TensorFlow', 'PyTorch',
      'React', 'TypeScript', 'D3.js', 'PostgreSQL',
      'Redis', 'Docker', 'Kubernetes', 'AWS', 'Kafka'
    ],
    ...
    demoUrl: null,
    githubUrl: null,
    tags: ['AI', 'Ciberseguridad', 'Machine Learning', 'Enterprise', 'Cloud']
  },

  {
    id: 'bug-bounty-ai',
    slug: 'bug-bounty-ai-analyzer',
    title: 'IA Analista de Vulnerabilidades de Bug Bounty Automatizada',
    category: 'Ciberseguridad',
    status: 'En Desarrollo',
    featured: true,
    shortDescription: 'Sistema inteligente que utiliza IA para automatizar el análisis y detección de vulnerabilidades en programas de Bug Bounty.',
    description: `IA Analista de Vulnerabilidades es una herramienta avanzada que combina inteligencia artificial con técnicas de pentesting automatizado para identificar vulnerabilidades de seguridad en aplicaciones web y APIs.

El sistema utiliza modelos de aprendizaje automático entrenados con millones de reportes de Bug Bounty para predecir y detectar vulnerabilidades comunes y avanzadas, optimizando el proceso de hunting y aumentando las posibilidades de descubrir issues críticos.`,
...
Actualmente en **desarrollo activo** con múltiples módulos funcionales. Beta testing en programas privados de Bug Bounty.`,

    technologies: [
      'Python', 'TensorFlow', 'Transformers', 'asyncio',
      'MongoDB', 'Redis', 'Docker', 'Burp Suite',
      'Nuclei', 'Amass', 'FFuF', 'Kubernetes'
    ],
    ...
    demoUrl: null,
    githubUrl: null,
    tags: ['AI', 'Bug Bounty', 'Pentesting', 'Automatización', 'Ciberseguridad']
  },

  {
    id: 'portfolio',
    slug: 'portfolio-profesional',
    title: 'Portafolio Profesional Interactivo',
    category: 'Web Development',
    status: 'Completado',
    featured: true,
    shortDescription: 'Portafolio personal de nivel mundial con diseño premium y múltiples rutas.',
    description: 'Portafolio profesional construido con SvelteKit, featuring diseño moderno, animaciones fluidas, y arquitectura multi-página optimizada para GitHub Pages.',
    technologies: ['SvelteKit', 'TailwindCSS', 'JavaScript'],
    images: [],
    demoUrl: 'https://almanindahouse.github.io/Portafolio-Profesional',
    githubUrl: 'https://github.com/AlmanInDaHouse/Portafolio-Profesional',
...

  {
    ...
    title: 'Laboratorio de Seguridad de Redes',
    category: 'Ciberseguridad',
    status: 'Completado',
    featured: false,
    shortDescription: 'Entorno virtualizado para pruebas de penetración y análisis de seguridad.',
    description: 'Laboratorio completo de seguridad con máquinas virtuales, herramientas de pentesting y escenarios de ataque/defensa. Incluye implementación de IDS/IPS, análisis de tráfico y respuesta a incidentes.',
    technologies: ['VirtualBox', 'Kali Linux', 'Wireshark', 'Metasploit', 'pfSense'],
    images: [],
    tags: ['Seguridad', 'Redes', 'Pentesting']
  }
];
